...
struct nova_sb_info {
	...
	struct journal_ptr_pair *journal_ptr_pairs;

	/* pointing to current AIN allocate location */
	struct curr_ain_loc_percpu *curr_ain_loc;

	/* ain group des */
	struct ain_group_des_percpu *ain_group_des;

	/* pointing to slot node */
	u64 *to_slot_node;
